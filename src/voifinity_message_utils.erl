...
server_status(From,MessageId,Message) ->
  ...
  Message3 = Message2 ++ [{<<"status">>,<<"sent">>},{<<"class">>,<<"messageStatus">>}],
  FinalMessage = {[{<<"data">>,Message3}]},
  EncodedFinalMsg = jsx:encode(element(1,FinalMessage)),
...
server_status_delivered(From,MessageId,Message) ->
  ...
  Message4 = lists:keyreplace(<<"clientId">>,1,Message3,{<<"clientId">>,From}),
  Message5 = Message4 ++ [{<<"status">>,<<"delivered">>},{<<"class">>,<<"messageStatus">>}],
